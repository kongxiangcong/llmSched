...
class PrefillThroughputSummary(BaseModel):
    ...
    projection_cycles: float = Field(ge=0.0, default=0.0)
    projection_fitted_work_cycles: float = Field(ge=0.0, default=0.0)
    kv_io_cycles: float = Field(ge=0.0, default=0.0)
    kv_io_fitted_work_cycles: float = Field(ge=0.0, default=0.0)
    attention_cycles: float = Field(ge=0.0, default=0.0)
    ...
    other_cycles: float = Field(ge=0.0, default=0.0)

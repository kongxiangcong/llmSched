...
def test_build_visualization_catalog_generates_static_index_assets() -> None:
    ...
    assert 'buildWorkbenchHref(match.sourceEntry.workbench_entry_path, "sweep", { compare_focus: currentCompareFocus(), layer_delta_focus: currentLayerDeltaFocus(), analysis_flow: currentWorkspaceAnalysisFlow() })' in files["catalog/assets/app.js"]
    assert 'buildWorkbenchHref(match.sourceEntry.workbench_entry_path, "sweep", { compare_focus: currentCompareFocus(), layer_delta_focus: currentLayerDeltaFocus(), analysis_flow: currentWorkspaceAnalysisFlow(), sweep_candidate: candidateEntry.target_profile_name, sweep_layer_focus: layerId })' in files["catalog/assets/app.js"]

...
def test_build_visualization_catalog_generates_static_index_assets() -> None:
    ...
    assert "catalog-compare-focus-filter" in files["catalog/index.html"]
    ...
    assert "function currentCompareFocus" in files["catalog/assets/app.js"]
    assert "function currentLayerDeltaFocus" in files["catalog/assets/app.js"]
    assert "function groupedCompareGroupIdsForFocus" in files["catalog/assets/app.js"]
    assert "function focusedGroupedScalarDeltaGroups" in files["catalog/assets/app.js"]
    assert "layer_delta_focus: currentLayerDeltaFocus()" in files["catalog/assets/app.js"]
    ...
    assert "compare_focus" in files["catalog/assets/app.js"]
    assert "layer_delta_focus" in files["catalog/assets/app.js"]
    assert "workspace_candidate" in files["catalog/assets/app.js"]
    assert "workspace_detail_focus" in files["catalog/assets/app.js"]
    assert "workspace_secondary_detail_focus" in files["catalog/assets/app.js"]
    assert "workspace_detail_preset" in files["catalog/assets/app.js"]
    assert "workspace_analysis_flow" in files["catalog/assets/app.js"]
    ...
    assert "function buildWorkspaceRecommendationParams" in files["catalog/assets/app.js"]
    assert 'recommendation_queue_position' in files["catalog/assets/app.js"]
    assert 'recommendation_prev_candidate' in files["catalog/assets/app.js"]
    assert 'recommendation_next_candidate' in files["catalog/assets/app.js"]
    assert 'recommendation_top_candidates' in files["catalog/assets/app.js"]
    assert 'recommendation_queue_candidates' in files["catalog/assets/app.js"]
    assert 'const workbenchCompareParams = buildWorkspaceRecommendationParams(resolveCurrentWorkspaceState(), candidateEntry);' in files["catalog/assets/app.js"]
    assert 'const workbenchCompareParams = {' in files["catalog/assets/app.js"]
    assert '...buildWorkspaceRecommendationParams(resolveCurrentWorkspaceState(), candidateEntry),' in files["catalog/assets/app.js"]
    assert 'buildWorkbenchHref(match.sourceEntry.workbench_entry_path, "sweep", workbenchCompareParams)' in files["catalog/assets/app.js"]
    ...
    assert "Focused Compare Focus" in files["catalog/assets/app.js"]
    ...
    assert "Focused Workspace Candidate" in files["catalog/assets/app.js"]
    assert "Focused Workspace Detail" in files["catalog/assets/app.js"]
    assert "Focused Workspace Compare-Against Detail" in files["catalog/assets/app.js"]
    assert "Focused Workspace Compare Preset" in files["catalog/assets/app.js"]
    assert "Focused Workspace Analysis Flow" in files["catalog/assets/app.js"]
    assert "Focused Workspace Analysis Flow Summary" in files["catalog/assets/app.js"]
    assert "Focused Sweep Candidate" in files["catalog/assets/app.js"]
    assert "Focused Sweep Layer" in files["catalog/assets/app.js"]
    assert "focused_workspace_candidate" in files["catalog/assets/app.js"]
    assert "focused_workspace_detail_focus" in files["catalog/assets/app.js"]
    assert "focused_workspace_secondary_detail_focus" in files["catalog/assets/app.js"]
    assert "focused_workspace_detail_preset" in files["catalog/assets/app.js"]
    assert "focused_workspace_analysis_flow" in files["catalog/assets/app.js"]
    assert "focused_workspace_analysis_flow_summary" in files["catalog/assets/app.js"]
    assert "Focused Workspace Compare Drilldown" in files["catalog/assets/app.js"]
    assert "Focus In Workspace" in files["catalog/assets/app.js"]
    ...
    assert "Summary Focus" in files["catalog/assets/app.js"]
    assert "Throughput / Latency Focus" in files["catalog/assets/app.js"]
    assert "Phase Shape Focus" in files["catalog/assets/app.js"]
    assert "Memory Pressure Focus" in files["catalog/assets/app.js"]
    assert "Schedule Shape Focus" in files["catalog/assets/app.js"]
    assert "Estimated Layer Focus" in files["catalog/assets/app.js"]
    assert "Fitted Layer Focus" in files["catalog/assets/app.js"]
    ...
    assert 'groupedCompareGroupIdsForFocus(currentCompareFocus())' in files["catalog/assets/app.js"]
    ...
    assert "function currentWorkspaceDetailFocus" in files["catalog/assets/app.js"]
    assert "function currentWorkspaceDetailFocusLabel" in files["catalog/assets/app.js"]
    assert "function currentWorkspaceSecondaryDetailFocus" in files["catalog/assets/app.js"]
    assert "function currentWorkspaceSecondaryDetailFocusLabel" in files["catalog/assets/app.js"]
    assert "function currentWorkspaceDetailPreset" in files["catalog/assets/app.js"]
    assert "function resolveWorkspaceDetailPreset" in files["catalog/assets/app.js"]
    assert "function currentWorkspaceAnalysisFlow" in files["catalog/assets/app.js"]
    assert "function resolveWorkspaceAnalysisFlow" in files["catalog/assets/app.js"]
    assert "function resolveWorkspaceAnalysisFlowRecommendation" in files["catalog/assets/app.js"]
    assert "function buildWorkspaceRowAnalysisFlowLink" in files["catalog/assets/app.js"]
    assert "function buildWorkspaceDetailFocusLink" in files["catalog/assets/app.js"]
    assert "function buildWorkspaceRowPresetLink" in files["catalog/assets/app.js"]
    assert "function buildWorkspaceRowSectionFocusLink" in files["catalog/assets/app.js"]
    assert "function orderWorkspaceDrilldownSections" in files["catalog/assets/app.js"]
    assert "function resolveWorkspaceCompareRowState" in files["catalog/assets/app.js"]
    assert "function resolveFocusedWorkspaceCandidate" in files["catalog/assets/app.js"]
    assert "function buildWorkspaceFocusLink" in files["catalog/assets/app.js"]
    assert "function renderFocusedWorkspaceDrilldown" in files["catalog/assets/app.js"]
    assert "Focus Compare Section" in files["catalog/assets/app.js"]
    assert 'buildWorkspaceRowSectionFocusLink(candidateEntry, "summary", "Summary Compare")' in files["catalog/assets/app.js"]
    assert 'buildWorkspaceRowSectionFocusLink(candidateEntry, "grouped-metrics", "Grouped Metric Deltas")' in files["catalog/assets/app.js"]
    assert 'buildWorkspaceRowSectionFocusLink(candidateEntry, "estimated-layer", "Estimated Layer Deltas")' in files["catalog/assets/app.js"]
    assert 'buildWorkspaceRowPresetLink(candidateEntry, "grouped-vs-estimated-layer", "Grouped Metrics vs Estimated Layer")' in files["catalog/assets/app.js"]
    assert 'buildWorkspaceRowPresetLink(candidateEntry, "summary-vs-estimated-layer", "Summary vs Estimated Layer")' in files["catalog/assets/app.js"]
    assert 'buildWorkspaceRowAnalysisFlowLink(candidateEntry, "grouped-hotspots", "Grouped Hotspots")' in files["catalog/assets/app.js"]
    assert 'buildWorkspaceRowAnalysisFlowLink(candidateEntry, "summary-hotspots", "Summary Hotspots")' in files["catalog/assets/app.js"]
    assert "Analysis Flow Summary" in files["catalog/assets/app.js"]
    assert "Recommended For Current Flow" in files["catalog/assets/app.js"]
    assert "Analysis Flow Candidate Recommendation" in files["catalog/assets/app.js"]
    assert "Recommendation Queue" in files["catalog/assets/app.js"]
    assert "Top Recommended Candidates" in files["catalog/assets/app.js"]
    assert "Previous Recommended Candidate" in files["catalog/assets/app.js"]
    assert "Next Recommended Candidate" in files["catalog/assets/app.js"]
    assert "Open Top Recommendation" in files["catalog/assets/app.js"]
    assert "focused_workspace_analysis_recommendation" in files["catalog/assets/app.js"]
    assert "focused_workspace_recommendation_queue" in files["catalog/assets/app.js"]
    assert "focused_workspace_recommendation_details" in files["catalog/assets/app.js"]
    assert "Recommendation Detail Blocks" in files["catalog/assets/app.js"]
    assert "Top Recommendation Detail Candidates" in files["catalog/assets/app.js"]
    assert "function buildWorkspaceRecommendationDetailEntries" in files["catalog/assets/app.js"]
    assert "function renderWorkspaceRecommendationDetailBlocks" in files["catalog/assets/app.js"]
    assert "function buildRecommendationDetailLayerSummary" in files["catalog/assets/app.js"]
    assert "function buildRecommendationDetailSnapshotLines" in files["catalog/assets/app.js"]
    assert "function renderRecommendationDetailEntryMarkup" in files["catalog/assets/app.js"]
    assert "analysis_flow_recommendation" in files["catalog/assets/app.js"]
    assert "recommendation_tier" in files["catalog/assets/app.js"]
    assert "recommendation_reason" in files["catalog/assets/app.js"]
    assert "queue_position" in files["catalog/assets/app.js"]
    assert "previous_candidate_entry_id" in files["catalog/assets/app.js"]
    assert "next_candidate_entry_id" in files["catalog/assets/app.js"]
    assert "top_recommendation_entry_ids" in files["catalog/assets/app.js"]
    assert "analysis_flow: currentWorkspaceAnalysisFlow()" in files["catalog/assets/app.js"]
    assert 'buildWorkbenchHref(entry.workbench_entry_path, panel, workbenchCompareParams)' in files["catalog/assets/app.js"]
    ...
    assert 'buildWorkspacePrimaryDeltaContent(entry, rowState.sameMetric, rowState.delta)' in files["catalog/assets/app.js"]
    assert 'buildWorkspacePrimaryRatioContent(entry, rowState.sameMetric, rowState.ratio)' in files["catalog/assets/app.js"]
    assert 'buildWorkspaceSharedMetricContent(baselineEntry, entry, sweepComparison)' in files["catalog/assets/app.js"]
    ...
    assert "function resolveWorkspaceRecommendationQueue" in files["catalog/assets/app.js"]
    assert "function renderWorkspaceRecommendationQueue" in files["catalog/assets/app.js"]

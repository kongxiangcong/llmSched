...
def test_build_visualization_catalog_generates_static_index_assets() -> None:
    ...
    assert 'buildTitledDirectionTagMarkup("workspace summary"' in files["catalog/assets/app.js"]
    assert 'buildTitledDirectionTagMarkup("workspace ratio summary"' in files["catalog/assets/app.js"]

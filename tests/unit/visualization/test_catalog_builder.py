...
def test_build_visualization_catalog_generates_static_index_assets() -> None:
    ...
    assert "buildWorkspaceCompareSummaryTag(baselineEntry, entry)" in files["catalog/assets/app.js"]
    ...
    assert 'buildTitledDirectionTagMarkup("workspace sweep summary"' in files["catalog/assets/app.js"]
    assert 'buildTitledScalarDeltaDirectionTag("workspace summary"' in files["catalog/assets/app.js"]
    assert 'buildTitledScalarDeltaDirectionTag("workspace ratio summary"' in files["catalog/assets/app.js"]
    assert 'candidate regressions' in files["catalog/assets/app.js"]

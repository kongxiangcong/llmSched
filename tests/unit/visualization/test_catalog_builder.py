...
def test_build_visualization_catalog_generates_static_index_assets() -> None:
    ...
    assert 'buildWorkspacePrimaryDeltaContent(sameMetric, delta)' in files["catalog/assets/app.js"]
    assert 'buildWorkspacePrimaryRatioContent(sameMetric, ratio)' in files["catalog/assets/app.js"]

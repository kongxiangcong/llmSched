...
def test_prefill_evaluation_report_tracks_throughput_memory_and_hotspots() -> None:
            ...
            "throughput": {
                ...
                "phase_attribution": {
                    ...
                    "attention": {
                        ...
                        "sync_cycles": 0.0,
                        "schedule_compression_cycles": 512.0,
                        "schedule_compression_ratio": 512.0 / 2048.0,
                        "schedule_overhang_cycles": 0.0,
    ...
    assert report.throughput.phase_attribution["projection"].schedule_compression_cycles == 512.0
    assert report.throughput.phase_attribution["attention"].schedule_compression_ratio == 0.25
    assert report.throughput.phase_attribution["other"].schedule_overhang_cycles == 0.0
    ...
    assert report.throughput.phase_attribution["projection"].occupied_slot_balance_ratio == 1.0
    assert report.throughput.phase_attribution["projection"].span_imbalance_slots == 0.0
    assert report.throughput.phase_attribution["projection"].span_balance_ratio == 1.0
